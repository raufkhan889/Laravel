...
@section('content')
    <div class="upload-details">
        <form action="{{ route('uploads.update', $video->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $video->title }}" name="title"
                                        placeholder="Video Title here ..." id="e1" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <select id="e3" name="category_id" class="custom-select">
                                        <option value="{{ $video->category->id }}">
                                            {{ $video->category->name }}
                                        </option>
